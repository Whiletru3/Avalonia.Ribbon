...
public class RibbonWindow : Window
{
    ...
    public RibbonWindow()
    {
        // Расширяем контент под системный titlebar
        // Системные кнопки остаются нативными (красивыми)
        // Только сам текст заголовка перекрывается нашим контентом
    ...
    private void SetupSide(string name, StandardCursorType cursor, WindowEdge edge, ref TemplateAppliedEventArgs e)
    {
        ...
        control.PointerPressed += (_, ep) => BeginResizeDrag(edge, ep);
    }
}
